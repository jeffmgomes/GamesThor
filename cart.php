			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
									...
									if(count($cart) > 0){										
											while ($row = mysqli_fetch_array($items, MYSQLI_ASSOC)){
												...
												<div class='cart_item_info d-flex flex-md-row flex-column justify-content-between'>
													...
													<div class='cart_item_total cart_info_col'>
														<form method='POST' action='php/removeItem.php?prod=". $row['ProductID'] ."' style='display: inline-block'>
															<input type='image' src='images/trash.png' alt='' style='margin-top:30px'>
														</form>
													</div>
												</div>
											</li>";
						...
						<form action="php/clearCart.php" style="display: inline">
							<button type="submit" class="button cart_button_clear">Clear Cart</button>
						</form>
						<form action="checkout.php" style="display: inline">
